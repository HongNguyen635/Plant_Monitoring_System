/*
  ...
  Debug javascrip: write, compile, upload, refresh, guess, repeat

  Anyway, this is a dashboard website to display the plant's sensors information
  and send commands from the website to the central controller.
*/
